...
import {
  ...
  DEFAULT_MOUSE_REACT,
  DEFAULT_SPEED,
} from "./iridescence.constants";
import { vertexShader, fragmentShader } from "./iridescence.shaders";
import type { BackgroundIridescenceProps } from "./iridescence.types";

export const BackgroundIridescence = ({
  color = DEFAULT_COLOR,
  speed = DEFAULT_SPEED,
